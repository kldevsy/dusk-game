...
export const roteiros = {
  leon: [
    ...
    { type:'msg', autor:'leon', text:'Obrigado por aguardar.', delay:800 },
    { type:'end', nextChat:'rafa' }
  ],
  rafa: [
    { type:'msg', autor:'rafa', text:'Ei, adicionei você para mostrar algo.', delay:1000 },
    { type:'msg', autor:'rafa', text:'Olha essa foto da câmera de segurança.', delay:1200 },
